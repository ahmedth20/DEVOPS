...
public class DepartementRestController {
	...
	@GetMapping("/filter")
	public List<Departement> filterDepartements(
			@RequestParam(required = false) String nomDepart,
			@RequestParam(required = false) Integer minEtudiants) {
		return departementService.filterDepartements(nomDepart, minEtudiants);
	}
